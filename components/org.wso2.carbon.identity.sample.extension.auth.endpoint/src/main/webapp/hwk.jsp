    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-3 col-centered wr-content wr-login col-centered">
                <div>
                    <h2 class="wr-title uppercase blue-bg padding-double white boarder-bottom-blue margin-none">Hardware Key </h2>
                </div>
                    ...
                    <div class="padding-double login-form">
                        ...
                        <form action="" method="post" id="loginForm">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                                <input id="generatedNumber" name="generatedNumber" type="text" value="<%=nextNum%>" class="form-control" tabindex="0"
